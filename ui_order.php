  ...
  <div class="card-body">
	...
	<div class="form-row">
		<div class="form-group col-sm-4">
		  ...
		  <button type="submit" class="btn btn-primary btn-round" name="btn_search" id="btn_search">ค้นหา</button>
		</div>
	</div>
	</form>
		   </div>
...
$num = 0;
	$sql = "
SELECT * FROM person INNER JOIN product ON person.Per_Id=product.Per_Id where person.Per_Id ='".$_SESSION['Userid']."'
";
